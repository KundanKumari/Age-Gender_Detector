...
heading.pack()
top.mainloop()
# we weren't able to see the labels, because we haven't classify detected anything yet, so these features are hidden corrently.
# but we will be displayed when the full code is completed and we will able to see the out put file.
